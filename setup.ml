...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7906fea1002c115019106c6dc8933106) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_prometheus", []))];
     ...
     package =
       {
          ...
          homepage = Some "http://github.com/prepor/prometheus-ocaml";
          synopsis = "Prometheus client library";
          description = Some [OASISText.Para "Prometheus client library"];
          categories = [];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "suite.ml"});
               Test
                 ({
                     cs_name = "main";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "test_prometheus"
                        ]
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "%Ìl «òD\140{<Gg[Q\020u";
     oasis_exec = None;
